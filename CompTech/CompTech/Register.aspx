<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="CompTech.Register" %>
...
&nbsp;<br />
    &nbsp;<br />
    <br />
    <asp:Button ID="btnSubmit" runat="server" CssClass="auto-style2" OnClick="btnSubmit_Click" Text="Submit" Width="133px" />
    <br />
    <br />
